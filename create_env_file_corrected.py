#!/usr/bin/env python3
"""
Script para crear el archivo .env con la configuración corregida de las tres bases de datos
"""

import os

def create_env_file():
    """Crea el archivo .env con la configuración corregida de las tres bases de datos"""
...
"""
    ...
    print(f"✅ Archivo .env actualizado en: {env_file_path}")
    print("\n📋 CONFIGURACIÓN CORREGIDA:")
    print("=" * 50)
    print("🏠 BASE PRINCIPAL (OneSite):")
    print(f"   📡 Servidor: SATURNO13")
    print(f"   🗄️  Base de datos: OnesiteDW")
...
if __name__ == "__main__":
    print("🔧 Actualizando archivo .env con configuración corregida...")
    print("=" * 70)
    
    if create_env_file():
        print("\n✅ ¡Configuración corregida completada!")
        print("\n📋 Próximos pasos:")
        print("  1. Ejecutar: python test_three_databases_corrected.py")
        print("  2. Reiniciar el backend")
        print("  3. Verificar endpoints en Swagger")
    else:
        print("\n❌ Error al actualizar el archivo .env") 